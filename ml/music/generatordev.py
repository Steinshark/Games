...
def build_encdec(in_factors=[],enc_factors=[],dec_factors=[],bs=8,leak=.2):
    #Constants 
    ...
    G.append(           Upsample(scale_factor=dec_strides[0]*2))
    ...
    G.append(           Upsample(scale_factor=dec_strides[1]*2))
    ...
    G.append(           Upsample(scale_factor=dec_strides[2]*2))
    ...
    G.append(           Upsample(scale_factor=dec_strides[3]*2))
